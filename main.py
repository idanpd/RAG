    ...
    def interactive_mode(self):
        ...
        try:
            ...
            if not available_llms:
                print("\n⚠️  No LLMs available. Search-only mode.")
                use_rag = False
            else:
        ...
        if use_rag:
            ...
            print("  - Use 'llm: <llm_name>' to switch LLM")
        ...
        while True:
            try:
                ...
                if user_input.lower() in ['quit', 'exit', 'q']:
                    ...
                    llm_name = user_input[4:].strip()
                    if rag_system.set_active_llm(llm_name):
                        print(f"✅ Switched to LLM: {llm_name}")
                    else:
                        print(f"❌ LLM not available: {llm_name}")
